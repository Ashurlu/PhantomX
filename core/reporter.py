...
<head>
<meta charset="UTF-8">
<title>AGI Pentest Report - {session.session_id[:8]}</title>
<style>
...
<div class="meta-grid">
  ...
  <div class="meta-item">
    ...
    <div class="meta-value class-status-{session.status}">{session.status.upper()}</div>
  </div>
  <div class="meta-item">
...
<footer>Generated by AGI Pentest Tool &bull; {datetime.utcnow().isoformat()} UTC</footer>
</body>
</html>"""
