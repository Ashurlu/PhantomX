...
PROVIDER_CATALOG = {
    ...
    # Groq (fast inference)
    "groq-llama-70b": {"provider": "groq", "model": "groq/llama-3.1-70b-versatile"},
    ...
    "openrouter-claude-sonnet": {"provider": "openrouter", "model": "openrouter/anthropic/claude-sonnet-4-5"},
